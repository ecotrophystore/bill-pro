    ...
    return await db.runTransaction(async (transaction) => {
        ...
        if (matchedLead) {
            ...
            if (normalized.location)
                leadUpdate.location = normalized.location;
            if (normalized.required_quantity)
                leadUpdate.required_quantity = normalized.required_quantity;
            if (normalized.event_date)
                leadUpdate.event_date = normalized.event_date;
            if (normalized.delivery_date)
                leadUpdate.delivery_date = normalized.delivery_date;
        ...
        if (normalized.location)
            leadData.location = normalized.location;
        if (normalized.required_quantity)
            leadData.required_quantity = normalized.required_quantity;
        if (normalized.event_date)
            leadData.event_date = normalized.event_date;
        if (normalized.delivery_date)
            leadData.delivery_date = normalized.delivery_date;

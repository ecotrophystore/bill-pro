  ...
  const handleGenerateInvoice = async () => {
    ...
    try {
      ...
      try {
        ...
        const { clientCreateInvoice } = await import('../utils/clientBillingCreator');
        await clientCreateInvoice(invoiceData);
        navigate('/invoices');
      } catch (clientError) {
        console.error("Client-side fallback also failed:", clientError);
        alert("Failed to create invoice. Connection or Permission issue.");
      }
    } finally {
      setIsSaving(false);
    }
              ...
              <div className="space-y-3">
                ...
                <div className="animate-fade-in space-y-3">
                  ...
                  <div className="space-y-1">
                    ...
                    <SpeechInput type="text" className="neo-input w-full" placeholder="Transaction ID, Cheque No..." value={advanceReferenceNumber} onChange={(e) => setAdvanceReferenceNumber(e.target.value)} />
                  </div>
                  <div className="h-px bg-shadow-darker/20 my-4"></div>
